...
namespace Project1
{
    public partial class ShortlistRent : System.Web.UI.Page
    {
        ...
        public void RepeaterData()
        {
            ...
            else
            {
                ...
                Panel2.Visible = true;
                SqlCommand cmd1 = new SqlCommand("select * from propertyforrent where pfrid IN " + query + ";", con);
                con.Open();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            con.Close();
            shortlisted = shortlisted.Replace("r"+s+" ", "");
