<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="ShortlistRent.aspx.cs" Inherits="Project1.ShortlistRent" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%" style="z-index: 0;">
        <asp:Panel ID="Panel17" runat="server" style="overflow: auto; padding-left: 1%; padding-right: 1%;">
            ...
            <asp:Panel ID="Panel18" runat="server" Height="25px" Width="10%" style="float: left; padding: 1%; padding-left: 0%; padding-right: 0%; padding-bottom: 0%; position: relative;">
                <asp:Button ID="Button1" runat="server" Text="For Sale" Width="100%" BackColor="White" style="border: none; border: 1px solid black; position: absolute; bottom: 0;" OnClick="Button1_Click" />
            </asp:Panel>
            <asp:Panel ID="Panel19" runat="server" Width="10%" style="float: left; padding: 1%; padding-left: 0%; padding-bottom: 0%;">
                <asp:Button ID="Button2" runat="server" Text="For Rent" Height="25px" Width="100%" BackColor="#1877f2" ForeColor="White" style="border: none; border:1px solid black;" OnClick="Button2_Click" />
            </asp:Panel>
                    ...
                    <asp:Panel ID="Panel3" runat="server" Width="98%" style="padding: 1%; z-index: 0;">
                        ...
                        <asp:Panel ID="Panel4" runat="server" Width="98%" Height="250px" CssClass="propcard" style="overflow: hidden; padding: 1%; position: relative; z-index: 0;" BorderStyle="Solid" BorderColor="Black" BorderWidth="1px">
                            <asp:Panel ID="Panel24" runat="server" Height="25px" style="position: absolute; right: 0; top: 0; padding: 5px; z-index: 0;">
                                <asp:Button ID="Button3" runat="server" Text="Remove from shortlisted" Height="25px" BackColor="#1877f2" ForeColor="White" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.pfrid")%>' style="border: none; border:1px solid black;" OnClick="Button3_Click" />
                            </asp:Panel>
                            ...
                            <asp:Panel ID="Panel6" runat="server" Width="68%" style="float: left; padding: 1%; z-index: 0;">
                                <asp:Panel ID="Panel7" runat="server" Width="100%" Font-Size="X-Large" Font-Bold="true" style="padding: 1%; z-index: 0;">
                                    ₹ <%# DataBinder.Eval(Container, "DataItem.rental_value").ToString().Length >= 8 ? 
